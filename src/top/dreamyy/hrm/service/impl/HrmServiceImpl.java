...
import top.dreamyy.hrm.dao.DeptDao;
import top.dreamyy.hrm.dao.DocumentDao;
import top.dreamyy.hrm.dao.EmployeeDao;
import top.dreamyy.hrm.dao.JobDao;
import top.dreamyy.hrm.dao.MessageDao;
import top.dreamyy.hrm.dao.NoticeDao;
import top.dreamyy.hrm.dao.UserDao;
...
public class HrmServiceImpl implements HrmService{
	...
	@Transactional(readOnly=true)
	@Override
	public List<Message> findMessage(Message message,PageModel pageModel) {
		/** 当前需要分页的总数据条数  */
		 Map<String,Object> params = new HashMap<>();
	   ...
	   pageModel.setRecordCount(recordCount);
	    ...
	    List<Message> messages = messageDao.selectByPage(params);
