		...
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr valign="top">
		    <td class="left_nav_bgshw" height="50">
			  ...
			  <c:set var="power" scope="session" value="${sessionScope.user_session.status}"></c:set>
			  <c:if test="${power==1}">
		  ...
		  <tr><td height="2"></td></tr>
		   ...
		   <tr><td id="navbg6" class="left_nav_closed" onClick="showsubmenu(6)"><div class="font1">留言信息管理</div></td></tr>
		  <tr valign="top" id="submenu6" style="display: none">
		    <td class="left_nav_bgshw tdbtmline" height="50">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/message/selectMessage" target="main">信息查询</a></img></p>					  
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
